...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/lunardate-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/lunardate-feedstock)
...
Once the `conda-forge` channel has been enabled, `lunardate` can be installed with:

```
conda install lunardate
```

It is possible to list all of the versions of `lunardate` available on your platform with:
